...
* target[0] = Reference(NgImmImmunization/immunization-001)
* target[+] = Reference(NgImmPatient/patient-001)
...
* location = Reference(NgImmLocation/location-001) // Surulere PHC, Lagos
...
// ---- Agent(s) involved ----
* agent[0].who = Reference(NgImmPractitionerRole/practitionerrole-001) // Routine Immunization Officer
* agent[0].role[0].coding[0].system = "http://terminology.hl7.org/CodeSystem/participation-role-type"


* agent[+].who = Reference(NgImmOrganization/organization-001) // Managing facility
...
* entity[0].what = Reference(DocumentReference/doc-immunization-tally-001)
...
* signature[0].who = Reference(NgImmPractitioner/practitioner-001)
