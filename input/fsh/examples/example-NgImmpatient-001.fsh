...
* identifier[NationalIDNo].type.coding[0].system = "https://nphcda.gov.ng/ig/ValueSet/patient-identifier-cs"
...
* identifier[ImmunizationRecordsNumber].type.coding[0].system = "https://nphcda.gov.ng/ig/ValueSet/patient-identifier-cs"
...
* identifier[BirthCertificateNo].type.coding[0].system = "https://nphcda.gov.ng/ig/ValueSet/patient-identifier-cs"
...
* identifier[InsuranceNumber].type.coding[0].system = "https://nphcda.gov.ng/ig/ValueSet/patient-identifier-cs"
