...
* reason[0].coding[0].code = #PAT
* reason[0].coding[0].display = "Patient Request"
...
* activity.coding[0].code = #End
* activity.coding[0].display = "wasEndedBy"
...
* agent[=].role[0].coding[0].system = "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
