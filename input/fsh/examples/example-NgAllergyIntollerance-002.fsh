...
* code.coding[0].code = #86872008
* code.coding[0].display = "Measles vaccine"

// ---- Subject and context ----
* patient = Reference(NgImmPatient/patient-003)           // Lagos patient example
* encounter = Reference(NgImmEncounter/encounter-002)

// ---- Timeline ----
* onsetDateTime = "2025-07-20T10:45:00+01:00"
* recordedDate = "2025-07-20T11:30:00+01:00"
* recorder = Reference(NgImmPractitioner/practitioner-006)
...
* reaction[0].manifestation[=].coding.code = #422587007
...
* reaction[0].substance.coding.code = #86872008
