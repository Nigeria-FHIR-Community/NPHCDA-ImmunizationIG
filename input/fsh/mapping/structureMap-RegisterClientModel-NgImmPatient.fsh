...
* url = "https://nphcda.gov.ng/ig/StructureMap/registerclientmodel-to-ngimmpatient"
* name = "RegisterClientModelToNgImmPatient"
* status = #active

// Source and target structures
* structure[0].url = "https://nphcda.gov.ng/ig/StructureDefinition/register-client-model"
* structure[0].mode = #source
* structure[0].alias = "rcm"

* structure[1].url = "https://nphcda.gov.ng/ig/StructureDefinition-NgImmPatient"
...
* group.rule[3].target.parameter[0].valueString = "https://nphcda.gov.ng/ig/ConceptMap/RCMSexToAdministrativeGender"
...
* group.rule[13].target.parameter[0].valueString = "https://nphcda.gov.ng/ig/StructureDefinition/NGAgeInWeeks"
...
* group.rule[14].target.parameter[0].valueString = "https://nphcda.gov.ng/ig/StructureDefinition/NGAgeInMonths"
...
* group.rule[15].target.parameter[0].valueString = "https://nphcda.gov.ng/ig/StructureDefinition/NGAgeInYears"
...
* group.rule[16].target.parameter[0].valueString = "https://nphcda.gov.ng/ig/StructureDefinition/NGBirthWeight"
