...
* url = "https://nphcda.gov.ng/ig/StructureMap/reportgeneration-to-measurereport"
* name = "ReportGenerationToMeasureReport"
* status = #active

// Structures
* structure[0].url = "https://nphcda.gov.ng/ig/StructureDefinition/reportgeneration"
* structure[0].mode = #source
* structure[0].alias = "RG"

* structure[1].url = "https://nphcda.gov.ng/ig/StructureDefinition/ngimm-measurereport"
* structure[1].mode = #target
* structure[1].alias = "MR"

* structure[2].url = "https://nphcda.gov.ng/ig/StructureDefinition/ngimm-measure"
