...
* url = "https://nphcda.gov.ng/ig/StructureMap/adminvaccine-to-immunization"
* name = "AdministerVaccineToFHIRResources"
* status = #active

* structure[0].url = "https://nphcda.gov.ng/ig/StructureDefinition/administervaccine"
* structure[0].mode = #source
* structure[0].alias = "AV"

* structure[1].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-immunization"
* structure[1].mode = #target
* structure[1].alias = "IMM"

* structure[2].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-location"
* structure[2].mode = #target
* structure[2].alias = "LOC"

* structure[3].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-practitioner"
* structure[3].mode = #target
* structure[3].alias = "PRAC"

* structure[4].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-encounter"
* structure[4].mode = #target
* structure[4].alias = "ENC"

* structure[5].url = "https://nphcda.gov.ng/ig/StructureDefinition/register-client-model"
...
* group[0].rule[0].target.parameter[0].valueString = "https://nphcda.gov.ng/ig/StructureDefinition/NGPregnancyStatus"
...
* group[0].rule[1].target.parameter[0].valueString = "https://nphcda.gov.ng/ig/StructureDefinition/NGHIVStatus"
