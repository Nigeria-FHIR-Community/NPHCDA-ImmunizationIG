...
* url = "https://nphcda.gov.ng/ig/StructureMap/defaultertracking-to-immunization"
* name = "DefaulterTrackingToImmunization"
* status = #active

// Structures
* structure[0].url = "https://nphcda.gov.ng/ig/StructureDefinition/defaultertracking"
* structure[0].mode = #source
* structure[0].alias = "DT"

* structure[1].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-patient"
* structure[1].mode = #target
* structure[1].alias = "PAT"

* structure[2].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-immunization"
* structure[2].mode = #target
* structure[2].alias = "IMM"

* structure[3].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-encounter"
* structure[3].mode = #target
* structure[3].alias = "ENC"

* structure[4].url = "https://nphcda.gov.ng/ig/StructureDefinition/ng-imm-practitioner"
