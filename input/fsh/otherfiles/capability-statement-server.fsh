...
* rest[0].resource[0].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-pseudo-id"
...
* rest[0].resource[0].searchParam[1].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-birthdate"
...
* rest[0].resource[0].searchParam[2].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-createddate"
...
* rest[0].resource[0].searchParam[3].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-gender"
...
* rest[0].resource[1].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/immunization-patient-pseudo-id"
...
* rest[0].resource[2].profile[0] = Canonical(NgImmClientRegistrationBundle) //All-Other-bundles-apply " NgImmRegisterFacilityBundle, NgImmUpdateClientBundle, NgImmManageReportAEFIBundle, NgImmGenerateReportBundle"
...
* rest[0].resource[2].searchParam[1].definition = "https://nphcda.gov.ng/ig/SearchParameter/bundle-lastUpdated"
...
* rest[0].resource[5].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/RelatedPerson-pseudo-id"
...
* rest[0].resource[6].operation[0].definition = "https://nphcda.gov.ng/ig/immunization/OperationDefinition/submit-ngimm-pr"
...
* rest[0].resource[6].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/Practitioner-pseudo-id"
