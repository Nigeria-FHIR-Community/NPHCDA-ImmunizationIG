...
* rest[0].resource[0].interaction[3].code = #history-instance
* rest[0].resource[0].interaction[4].code = #history-type
* rest[0].resource[0].interaction[5].code = #create
* rest[0].resource[0].interaction[6].code = #search-type
...
* rest[0].resource[1].interaction[3].code = #history-instance
* rest[0].resource[1].interaction[4].code = #history-type
* rest[0].resource[1].interaction[5].code = #create
* rest[0].resource[1].interaction[6].code = #search-type
