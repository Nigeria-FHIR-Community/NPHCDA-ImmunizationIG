...
* rest[0].resource[0].searchParam[0].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/patient-pseudo-id"
...
* rest[0].resource[0].searchParam[1].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/patient-birthdate"
...
* rest[0].resource[0].searchParam[2].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/patient-createddate"
...
* rest[0].resource[0].searchParam[3].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/patient-gender"
...
* rest[0].resource[1].searchParam[0].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/immunization-patient-pseudo-id"
...
* rest[0].resource[5].searchParam[0].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/RelatedPerson-pseudo-id"
...
* rest[0].resource[6].operation[0].definition = "http://nphcda.gov.ng/ig/immunization/immunization/OperationDefinition/submit-ngimm-pr"
...
* rest[0].resource[6].searchParam[0].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/Practitioner-pseudo-id"
...
* rest[0].resource[10].operation[0].definition = "http://nphcda.gov.ng/ig/immunization/OperationDefinition/submit-ngimm-bundle"
...
* rest[0].resource[10].searchParam[3].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/bundle-organization-identifier"
// Supported _revinclude
...
* rest[0].resource[11].operation[0].definition = "http://nphcda.gov.ng/ig/immunization/OperationDefinition/submit-ngimm-bundle"
...
* rest[0].resource[11].searchParam[3].definition = "http://nphcda.gov.ng/ig/immunization/SearchParameter/bundle-organization-identifier"
// Supported _revinclude
...
* rest[0].resource[12].operation[0].definition = "http://nphcda.gov.ng/ig/immunization/OperationDefinition/submit-ngimm-bundle"
...
* rest[0].resource[12].searchParam[3].definition = "http://nphcda.gov.ng/ig/immunization//SearchParameter/bundle-organization-identifier"
// Supported _revinclude
...
* rest[0].resource[13].operation[0].definition = "http://nphcda.gov.ng/ig/immunization/OperationDefinition/submit-ngimm-bundle"
