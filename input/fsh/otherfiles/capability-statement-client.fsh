...
* rest[0].resource[0].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-patient"
* rest[0].resource[0].searchParam[0].name = "identifier"
* rest[0].resource[0].searchParam[0].type = #token
* rest[0].resource[0].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-identifier"
* rest[0].resource[0].searchParam[1].name = "firstname"
* rest[0].resource[0].searchParam[1].type = #string
* rest[0].resource[0].searchParam[1].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-firstname"
* rest[0].resource[0].searchParam[2].name = "lastname"
* rest[0].resource[0].searchParam[2].type = #string
* rest[0].resource[0].searchParam[2].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-lastname"
* rest[0].resource[0].searchParam[3].name = "birthdate"
* rest[0].resource[0].searchParam[3].type = #date
* rest[0].resource[0].searchParam[3].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-birthdate"
* rest[0].resource[0].searchParam[4].name = "createddate"
* rest[0].resource[0].searchParam[4].type = #date
* rest[0].resource[0].searchParam[4].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-createddate"
* rest[0].resource[0].searchParam[5].name = "email_mobile"
* rest[0].resource[0].searchParam[5].type = #string
* rest[0].resource[0].searchParam[5].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-email-mobile"
* rest[0].resource[0].searchParam[6].name = "gender"
* rest[0].resource[0].searchParam[6].type = #token
* rest[0].resource[0].searchParam[6].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-gender"
* rest[0].resource[0].searchParam[7].name = "pseudo-id"
* rest[0].resource[0].searchParam[7].type = #token
* rest[0].resource[0].searchParam[7].definition = "https://nphcda.gov.ng/ig/SearchParameter/patient-pseudo-id"
...
* rest[0].resource[1].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-immunization"
* rest[0].resource[1].searchParam[0].name = "patient"
* rest[0].resource[1].searchParam[0].type = #reference
* rest[0].resource[1].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/immunization-patient"
* rest[0].resource[1].searchParam[1].name = "status"
* rest[0].resource[1].searchParam[1].type = #token
* rest[0].resource[1].searchParam[1].definition = "https://nphcda.gov.ng/ig/SearchParameter/immunization-status"
* rest[0].resource[1].searchParam[2].name = "vaccine-code"
* rest[0].resource[1].searchParam[2].type = #token
* rest[0].resource[1].searchParam[2].definition = "https://nphcda.gov.ng/ig/SearchParameter/immunization-vaccine-code"
* rest[0].resource[1].searchParam[3].name = "date"
* rest[0].resource[1].searchParam[3].type = #date
* rest[0].resource[1].searchParam[3].definition = "https://nphcda.gov.ng/ig/SearchParameter/immunization-date"
...
* rest[0].resource[2].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-bundle"
* rest[0].resource[2].searchParam[0].name = "patient.identifier"
* rest[0].resource[2].searchParam[0].type = #token
* rest[0].resource[2].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/bundle-patient.identifier"
* rest[0].resource[2].searchParam[1].name = "_lastUpdated"
* rest[0].resource[2].searchParam[1].type = #date
* rest[0].resource[2].searchParam[1].definition = "https://nphcda.gov.ng/ig/SearchParameter/bundle-_lastUpdated"
* rest[0].resource[2].searchParam[2].name = "vaccine-code"
* rest[0].resource[2].searchParam[2].type = #token
* rest[0].resource[2].searchParam[2].definition = "https://nphcda.gov.ng/ig/SearchParameter/bundle-vaccine-code"
* rest[0].resource[2].searchParam[3].name = "organization-identifier"
* rest[0].resource[2].searchParam[3].type = #token
* rest[0].resource[2].searchParam[3].definition = "https://nphcda.gov.ng/ig/SearchParameter/bundle-organization-identifier"
...
* rest[0].resource[3].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-organization"
* rest[0].resource[3].searchParam[0].name = "organization-identifier"
* rest[0].resource[3].searchParam[0].type = #token
* rest[0].resource[3].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/organization-identifier"
...
* rest[0].resource[4].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-encounter"
* rest[0].resource[4].searchParam[0].name = "encounter-identifier"
* rest[0].resource[4].searchParam[0].type = #token
* rest[0].resource[4].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/encounter-identifier"
...
* rest[0].resource[5].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-relatedperson"
* rest[0].resource[5].searchParam[0].name = "relatedperson-identifier"
* rest[0].resource[5].searchParam[0].type = #token
* rest[0].resource[5].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/relatedperson-identifier"
...
* rest[0].resource[6].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-practitioner"
* rest[0].resource[6].searchParam[0].name = "practitioner-identifier"
* rest[0].resource[6].searchParam[0].type = #token
* rest[0].resource[6].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/practitioner-identifier"
* rest[0].resource[6].searchParam[1].name = "license"
* rest[0].resource[6].searchParam[1].type = #token
* rest[0].resource[6].searchParam[1].definition = "https://nphcda.gov.ng/ig/SearchParameter/practitioner-license"
...
* rest[0].resource[7].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/submit-ngimm-measurereport"
* rest[0].resource[7].searchParam[0].name = "measurereport-identifier"
* rest[0].resource[7].searchParam[0].type = #token
* rest[0].resource[7].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/measurereport-identifier"
...
* rest[0].resource[8].searchParam[0].definition = "https://nphcda.gov.ng/ig/SearchParameter/provenance-identifier"
...
* rest[0].resource[9].operation[0].definition = "https://nphcda.gov.ng/ig/OperationDefinition/StructureMap-transform"
