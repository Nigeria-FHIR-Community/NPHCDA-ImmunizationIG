...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Measure">
      ...
      <sch:assert test="count(f:scoring) &gt;= 1">scoring: minimum cardinality of 'scoring' is 1</sch:assert>
      <sch:assert test="count(f:group) &gt;= 1">group: minimum cardinality of 'group' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Measure/f:identifier</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Measure/f:group">
      <sch:assert test="count(f:population) &gt;= 2">population: minimum cardinality of 'population' is 2</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
